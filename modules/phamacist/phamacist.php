...
$pageCss    = '/Web/Hospital-Management-System/modules/phamacist/phamacist.css';
$useSidebar = true;
$isPublic   = false;
...
<div class="ph-tab-strip no-print">
        <a href="/Web/Hospital-Management-System/modules/phamacist/phamacist.php"  class="ph-tab active"><i class="ti ti-prescription"></i> Dispensing</a>
        
        <a href="/Web/Hospital-Management-System/modules/pharmacy/pharmacy_queue.php" class="ph-tab "><i class="ti ti-shopping-cart"></i> Pharmacy Queue</a>
    </div>
    ...
    <div class="section-card no-print" id="lookupCard">
        ...
        <div style="display:flex;gap:8px;align-items:flex-end;margin-bottom:10px;">
            <div style="display:flex;flex-direction:column;gap:4px;flex:1;min-width:0;">
                <label for="pidIn" style="font-size:11px;font-weight:500;color:#5A6677;display:block;">Patient ID</label>
                <input type="text" id="pidIn"
                       ...
                       style="all:unset;box-sizing:border-box;display:block;width:100%;height:36px;padding:0 12px;background:#fff;border:1.5px solid #DDE3EC;border-radius:6px;font-size:13px;color:#0F1924;cursor:text;">
            </div>
            <button type="button" onclick="lookupPid()"
                    style="all:unset;box-sizing:border-box;display:inline-flex;align-items:center;gap:6px;height:36px;padding:0 18px;flex-shrink:0;background:#E6F1FB;color:#0C447C;border:1.5px solid #85B7EB;border-radius:10px;font-size:13px;font-weight:500;cursor:pointer;white-space:nowrap;">
