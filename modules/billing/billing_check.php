...
<style>
    ...
    /* appt select colours */
    .appt-sel option[value="pending"] {
        color: #92400e
    }

    .appt-sel option[value="confirmed"] {
        color: #075985
    }

    .appt-sel option[value="completed"] {
        color: #065f46
    }

    .appt-sel option[value="cancelled"] {
        color: #991b1b
    }

    /* pay select colours */
    .pay-sel option[value="Done"] {
        color: #065f46;
        font-weight: 600
    }

    .pay-sel option[value="Cancelled"] {
        color: #991b1b;
        font-weight: 600
    }
...
<script>
    ...
    function openModal(apptId, patId, patName, ref, fee, curStatus) {
        ...
        document.getElementById('m-fee').textContent = 'Rs. ' + parseFloat(fee).toLocaleString('en-LK', {
